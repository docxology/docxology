...
- Source report: `reports/external_links_2026-09-17.json`
- Checked URLs: 832
- OK: 689
- Warnings: 143
...
| --- | ---: | --- |
| `bot-protected-or-rate-limited` | 137 | Likely blocks automated checks; verify manually before replacing. |
...
| Status | URL | Sources |
| ---: | --- | --- |
| 0 | <https://pubmed.ncbi.nlm.nih.gov/38735269/> | pages/EVIDENCE.md, pages/EVIDENCE.md |
| 0 | <https://pubmed.ncbi.nlm.nih.gov/?term=Daniel+Ari+Friedman%5BAuthor%5D> | discovery.html, domain-biomedicine.html, pages/DISCOVERY.md |
