...
| Run accessibility and visual QA | [`docs/operations/accessibility-qa.md`](docs/operations/accessibility-qa.md) | `python3 code/orchestrators/accessibility_audit.py --check` plus browser/visual commands |
