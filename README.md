...
| ✅ [**reports/**](reports/) / [**CHANGELOG.md**](CHANGELOG.md) / [**docs/seo/canonical-policy.md**](docs/seo/canonical-policy.md) | **Maintenance evidence** — source snapshots, reconciliation reports, accessibility reports, visual QA screenshots, changelog, and canonical URL policy |
...
| [ntqr_llm](https://github.com/docxology/ntqr_llm) | Algebraic NTQR evaluation for LLM-persona accuracy recovery |
