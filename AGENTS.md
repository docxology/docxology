...
**Purpose**: Master profile repository indexing the unified bibliography (115 works), 48 owned software repositories (+32 AII contributions), and research documentation across Entomology, Active Inference, Cognitive Security, and Art & Synergetics.
...
- Validates documentation completeness across all paper folders (108 as of 2026-05-13)
...
- `data/reconciliation.json` and `reports/reconciliation_2026-05-13.md` are generated by `code/orchestrators/build_reconciliation_report.py`.
