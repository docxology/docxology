...
```bibtex
@article{Friedman_2020_DistributedPhysiology,
...
- `AGENTS.md` (2,040 bytes)
- `Friedman_2020_DistributedPhysiology.pdf` (711,416 bytes)
- `README.md` (1,914 bytes)
- `SKILL.md` (1,897 bytes)
