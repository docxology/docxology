# AGENTS.md — Introduction to Biology: A Generative Approach

**Paper**: Introduction to Biology: A Generative Approach (2026)
...
- Tracks citation links and DOI consistency for BiologyTextbook
...
### 🔗 INTEGRATOR
- Connects Introduction to Biology: A Generative Approach to related works in the bibliography
