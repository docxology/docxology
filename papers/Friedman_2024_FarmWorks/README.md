...
`FarmWorks` · `decentralized AI` · `precision agriculture` · `Active Inference` · `sensor networks` · `edge computing` · `farmer autonomy` · `sustainable agriculture` · `IoT` · `community-driven innovation`
...
```bibtex
@article{Friedman_2024_FarmWorks,
  author = {Daniel A. Friedman, Vladimir Baulin, Jonathan Minchin},
...
- `AGENTS.md` (1,756 bytes)
- `Friedman_2024_FarmWorks.pdf` (670,467 bytes)
- `README.md` (1,337 bytes)
