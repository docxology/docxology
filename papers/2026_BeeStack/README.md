...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.20420557.svg)](https://doi.org/10.5281/zenodo.20420557)
...
honeybee · Apis mellifera · active inference · simulation scaffold · swarm intelligence · niche construction · FlyBody · MuJoCo · antennal lobe · mushroom body · central complex · waggle dance · BEEHAVE · reproducible research
...
- `BeeStack_combined.pdf` - Zenodo PDF

## Citation

> Friedman, D. A. (2026). *BeeStack: An Evidence-Typed Scaffold for Whole-Colony Honeybee Simulation*. Zenodo. https://doi.org/10.5281/zenodo.20420557
