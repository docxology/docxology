# Agentic Security and Operating Systems: A Deep Review and Prospectus of OpSec, Cognitive Security, and Agentic Cyber Security

**Daniel Ari Friedman** (2026) · *Zenodo*

[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.22754351.svg)](https://doi.org/10.5281/zenodo.22754351)
...
agentic security · operating systems · compartmentalization · capability mediation · Qubes OS · NixOS · cognitive security · operational security · agent orchestration · offensive AI

## Artifacts

| Field | Value |
|------|-------|
| **DOI** | [10.5281/zenodo.22754351](https://doi.org/10.5281/zenodo.22754351) |
| **Published** | 2026-09-14 |
| **Version** | Unknown |
| **Zenodo record** | https://zenodo.org/records/22754351 |

## Files

- `agentic_os_security_combined.pdf` - Zenodo PDF

## Citation

> Daniel Ari Friedman (2026). *Agentic Security and Operating Systems: A Deep Review and Prospectus of OpSec, Cognitive Security, and Agentic Cyber Security*. Zenodo. DOI: 10.5281/zenodo.22754351. URL: https://doi.org/10.5281/zenodo.22754351.

## Related

- Zenodo record: https://zenodo.org/records/22754351
- Source: https://github.com/docxology/agentic_os_security
