...
`Free Energy Principle` · `Karl Friston` · `Bayesian brain` · `predictive processing` · `Markov blanket` · `consciousness` · `self-organization` · `variational inference` · `philosophy of mind`
...
```bibtex
@article{Friedman_2018_WoodliceAndMen,
  author = {Karl Friston, Martin Fortier, Daniel A. Friedman},
...
- `AGENTS.md` (2,094 bytes)
- `Friedman_2018_WoodliceAndMen.pdf` (756,170 bytes)
- `README.md` (2,116 bytes)
- `SKILL.md` (1,955 bytes)
