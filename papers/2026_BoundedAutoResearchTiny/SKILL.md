...
description: "Use for Bounded AutoResearch for a Tiny Reproducible Machine-Learning Task, a paired GitHub and Zenodo publication with DOI 10.5281/zenodo.20417017."
...
1. Ground citations in DOI `10.5281/zenodo.20417017`.
2. Treat the Zenodo record as the archival source and the GitHub release as the executable/source release.
3. Keep release tag `v0.2.0` and repository `docxology/template_autoresearch_project` linked when updating catalog surfaces.
