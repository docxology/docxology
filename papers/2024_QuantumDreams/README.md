...
`quantum mechanics` · `art` · `phenomenology` · `Active Inference` · `visual analysis` · `symbolism` · `Morse code`
...
```bibtex
@article{2024_QuantumDreams,
  author = {Daniel Ari Friedman, Dean Tickles},
...
- `AGENTS.md` (1,701 bytes)
- `2024_QuantumDreams.pdf` (1,003,135 bytes)
- `README.md` (1,378 bytes)
- `SKILL.md` (1,649 bytes)
