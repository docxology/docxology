...
This work addresses topics in **Active Inference**: Active Inference, conflict modeling, AIC model, OODA loops.
...
- Familiarity with Active Inference, conflict modeling, AIC model
