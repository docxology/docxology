...
```bibtex
@article{Friedman_2023_GenerativeResearchTeams,
  author = {Daniel Friedman, Jakub Smékal},
...
- `Friedman_2023_GenerativeResearchTeams.pdf` (376,476 bytes)
- `README.md` (1,531 bytes)
- `SKILL.md` (1,783 bytes)
