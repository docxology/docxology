...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.21047573.svg)](https://doi.org/10.5281/zenodo.21047573)
...
- `blake_working_paper.pdf` - Zenodo PDF

## Citation

> Friedman, D. A. (2026). *Mapping William Blake's Works: Evidence ledgers, source provenance, text-image diagnostics, and rights-bounded release controls*. Zenodo. https://doi.org/10.5281/zenodo.21047573
