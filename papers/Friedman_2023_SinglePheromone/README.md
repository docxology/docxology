...
```bibtex
@article{Friedman_2023_SinglePheromone,
  author = {Eric Saund, Daniel Ari Friedman},
...
- `AGENTS.md` (1,971 bytes)
- `Friedman_2023_SinglePheromone.pdf` (3,934,724 bytes)
- `README.md` (1,696 bytes)
- `SKILL.md` (1,848 bytes)
