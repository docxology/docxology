...
- Connect to **2026_ActInfMetaAnalysis** (literature systems), **2022_ActiveInferenceOntology** / **2024_OntologySUMO** (formal structure), and **AII** ecosystem software rows for related tooling.
...
- 2026_ActInfMetaAnalysis — literature architecture and assertions over Active Inference sources
- 2026_CognitiveCaseDiagrams — rigorous definitions bridging prose and structure (different formal stack)
- 2019_PhDDissertation / quantitative modeling papers — where variational and Bayesian statements originate informally
- 2022_ActiveInferenceOntology — explicit ontological commitment as a parallel to machine-checked statements
