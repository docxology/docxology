...
`NSF reporting` · `postdoctoral research` · `synthetic intelligence` · `automated reporting` · `research dissemination` · `prompt engineering`
...
- `AGENTS.md` (1,849 bytes)
- `2023_NSFReporting.pdf` (52,432 bytes)
- `README.md` (1,457 bytes)
- `SKILL.md` (1,682 bytes)
