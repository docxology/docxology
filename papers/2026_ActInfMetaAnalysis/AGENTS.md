...
- 2025_CEREBRUM — Active Inference modeling architecture
- 2025_DiscoveryEngine — AI-driven synthesis of scientific knowledge landscapes
- 2026_ReproducibleResearch — Reproducible research pipeline architecture
- 2024_OntologySUMO — Aligning Active Inference ontology
- 2023_DistributedScience — Scientific process as multi-scale Active Inference
