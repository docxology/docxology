...
from docxology_tools.release_evidence import is_ephemeral_release_evidence_path  # noqa: E402
...
WARNING_ARTIFACT_BYTES = 885 * 1024 * 1024
...
def _manifest_payload(existing: dict | None = None, *, include_pending_growth: bool = True) -> dict:
    ...
    payload = {
        ...
        "policy": {
            ...
            "warning_policy": "At 885 MiB, review growth and report retention before deployment; 900 MiB is a release hard ceiling below the GitHub Pages 1 GiB platform limit.",
        },
        "budget": {
