...
INDEX_PRIORITY_STATIC: list[tuple[str, str, str]] = [
    ...
    # Domain feeds (2026-08-29): feeds/domain-<slug>.xml are per-domain RSS
    # 2.0 assets generated by build_domain_feeds.py (one per build_domain_pages
    # domain slug). Like feed.xml above they are non-HTML XML assets and are
    # deliberately NOT sitemap entries — discovery is via <link rel="alternate">
    # tags in HTML heads, llms.txt, and robots comments. Their absence from
    # INDEX_PRIORITY_STATIC is intentional, not a gap.
