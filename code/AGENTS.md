...
| `src/report_paths.py` | Shared helpers for date-stamped report artifacts (`latest_report`, `dated_report_path`, `generated_timestamp`, `rel`, ...) — imported by 32 orchestrators through `docxology_tools`, no CLI of its own |
