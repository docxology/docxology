...
- **Post-deploy link evidence:** external-link triage is now recognized as a narrowly date-stamped post-deploy derivative only after its deterministic check matches the refreshed link report; malformed and unrelated report paths remain release-blocking source drift.
