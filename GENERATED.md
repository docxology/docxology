...
| Paired publication sync report | `reports/paired_publications_2026-06-04.json` | `GitHub Releases API`<br>`Zenodo Records API`<br>`docs/PUBLICATION_SYNC.md`<br>`code/src/publication_pairing.py`<br>`code/orchestrators/sync_paired_publications.py` | `python3 code/orchestrators/sync_paired_publications.py` |
| Paired publication review decisions | `data/paired-publication-decisions.json`<br>`reports/paired_publications_review_queue_2026-06-04.md` | `reports/paired_publications_2026-06-04.json`<br>`manual review decision` | `manual review; update data/paired-publication-decisions.json` |
...
| Public source snapshot | `reports/public_source_snapshot_2026-06-04.json` | `GitHub, ORCID, PubMed, Europe PMC, Crossref, Zenodo public APIs` | `python3 code/orchestrators/refresh_public_sources.py` |
| Public source inventory | `reports/public_source_inventory_2026-06-04.json` | `ORCID, Crossref, PubMed, Europe PMC, Zenodo, Wikidata, Semantic Scholar, GitHub, AII pages` | `python3 code/orchestrators/refresh_public_source_inventory.py` |
...
| Asset size audit | `reports/asset_size_2026-06-04.json` | `root HTML pages`<br>`og-*.jpg`<br>`data/*.json`<br>`style.css`<br>`sw.js` | `python3 code/orchestrators/audit_assets.py` |
