...
| Paired publication sync report | `reports/paired_publications_2026-05-27.json` | `GitHub Releases API`<br>`Zenodo Records API`<br>`code/src/publication_pairing.py`<br>`code/orchestrators/sync_paired_publications.py` | `python3 code/orchestrators/sync_paired_publications.py` |
...
| Public source snapshot | `reports/public_source_snapshot_2026-05-27.json` | `GitHub, ORCID, PubMed, Europe PMC, Crossref, Zenodo public APIs` | `python3 code/orchestrators/refresh_public_sources.py` |
| Public source inventory | `reports/public_source_inventory_2026-05-27.json` | `ORCID, Crossref, PubMed, Europe PMC, Zenodo, Wikidata, Semantic Scholar, GitHub, AII pages` | `python3 code/orchestrators/refresh_public_source_inventory.py` |
...
| Asset size audit | `reports/asset_size_2026-05-27.json` | `root HTML pages`<br>`og-*.jpg`<br>`data/*.json`<br>`style.css`<br>`sw.js` | `python3 code/orchestrators/audit_assets.py` |
...
| Sitemap | `sitemap.xml` | `works/*.html`<br>`papers/*/index.html`<br>`code/orchestrators/build_sitemap.py` | `python3 code/orchestrators/build_sitemap.py` |
| Visual QA | `reports/visual-qa/2026-05-15/*.png`<br>`reports/visual-qa/2026-05-15/manifest.json` | `root HTML pages`<br>`style.css` | `python3 code/orchestrators/visual_qa.py` |
