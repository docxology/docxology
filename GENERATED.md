...
| Live site verification | `reports/live_site_verification_2026-07-17.json` | `https://danielarifriedman.com/`<br>`GitHub Pages API` | `python3 code/orchestrators/verify_live_site.py` |
