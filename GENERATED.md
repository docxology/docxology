...
| Paired publication sync report | `reports/paired_publications_2026-05-27.json` | `GitHub Releases API`<br>`Zenodo Records API`<br>`docs/PUBLICATION_SYNC.md`<br>`code/src/publication_pairing.py`<br>`code/orchestrators/sync_paired_publications.py` | `python3 code/orchestrators/sync_paired_publications.py` |
