...
| Source coverage exceptions | `data/coverage-exceptions.json`<br>`reports/source_coverage_2026-08-25.json`<br>`reports/source_coverage_2026-08-25.md` | `data/works.json`<br>`code/orchestrators/build_coverage_exceptions.py` | `python3 code/orchestrators/build_coverage_exceptions.py` |
...
| Agent route manifest | `data/agent-index.json` | `data/current-counts.json`<br>`data/pages-artifact-manifest.json`<br>`data/github-repositories.json`<br>`data/works.json`<br>`data/software.json`<br>`data/claims.json`<br>`reports/*latest dated reports`<br>`code/orchestrators/build_agent_index.py` | `python3 code/orchestrators/build_agent_index.py` |
...
| GitHub Pages artifact | `bounded _site/ deployment projection`<br>`data/pages-artifact-manifest.json`<br>`reports/pages_artifact_growth_2026-08-25.json` | `tracked repository files`<br>`code/src/release_controls.py`<br>`code/orchestrators/build_pages_artifact.py`<br>`docs/operations/github-pages-artifact.md` | `python3 code/orchestrators/build_pages_artifact.py --write-manifest --output /tmp/docxology-pages --check-size --check-manifest` |
...
| Asset size audit | `reports/asset_size_2026-08-25.json` | `root HTML pages`<br>`og-*.jpg`<br>`data/*.json`<br>`style.css`<br>`sw.js` | `python3 code/orchestrators/audit_assets.py` |
| Static accessibility report | `reports/accessibility_static_2026-08-25.json` | `root HTML pages`<br>`style.css`<br>`code/orchestrators/accessibility_audit.py` | `python3 code/orchestrators/accessibility_audit.py` |
| Browser smoke checks | `reports/browser-smoke/2026-08-25/*.png`<br>`reports/browser-smoke/2026-08-25/manifest.json` | `root HTML pages`<br>`works/index.html`<br>`search-index.json` | `python3 code/orchestrators/browser_smoke.py` |
| Progressive browser QA | `reports/browser-qa/2026-08-25/manifest.json` | `root HTML pages`<br>`js/*.js`<br>`style.css`<br>`code/orchestrators/browser_qa.py` | `uv run --extra browser-qa python3 code/orchestrators/browser_qa.py` |
...
| Visual QA | `reports/visual-qa/2026-08-25/*.png`<br>`reports/visual-qa/2026-08-25/manifest.json` | `root HTML pages`<br>`style.css` | `python3 code/orchestrators/visual_qa.py` |
