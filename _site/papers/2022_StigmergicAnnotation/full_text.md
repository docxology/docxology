# Full Text: StigmergicAnnotation

> Extracted from `2022_StigmergicAnnotation.pdf`
...
Social Media (HT ’22), June 28-July 1, 2022, Barcelona, Spain. ACM, New York, NY, USA, 5 pages. https://doi.org/10.1145/3511095.3536361
1
INTRODUCTION
The web has become a dominant epistemic environment, shaping peoples’ beliefs and knowledge on a global scale. The
web, however, is also currently a severely polluted epistemic environment [12], due to highly centralized and opaque
...
and distribute information [13]. Centralization leads to opacity, in which network data as well as algorithms for content
creation, search, and distribution are effectively hidden away from public, scientific, and ethical oversight [1].
Platform incentives are fundamentally misaligned with those necessary for healthier epistemic environments [24]. For
example, centralization and control of data are necessary for running lucrative “attention markets”, but ultimately hinder
attempts to address information overload, and undermine both user autonomy [19] as well as the open information
networks necessary for healthy democracies [11, 25]. Platforms are implicated in a host of problematic social phenomena,
including the spread of false information, behavioral changes, and societal polarization, epistemic distraction and
degradation of individual and collective sense-making capacities [13, 23]. Impending global ecological and societal
crises lend increased urgency to addressing these problems: astute collective sense- and decision-making have perhaps
never been more needed [1, 22, 23].
...
1
arXiv:2205.06345v1  [cs.SI]  12 May 2022

## Page 2

HT ’22, June 28-July 1, 2022, Barcelona, Spain
Tamari, Friedman, Fischer, Hebert and Shahaf
Laudable recent efforts have called attention to this precarious state of affairs of collective online sensemaking [1, 11,
13]. However, while providing invaluable insights, they have largely focused on improving platforms through regulatory
...
cannot adequately account for the fundamentally distributed [8], self-organizing [7], and stigmergic [15] nature of
...
collective conceptual transition to a “maker” mindset [10]; from passive users, to more active (sense)makers.
...
technology (e.g., Solid [18]). In this way, makers will control creation and dissemination of their annotations, which can
then be leveraged to optimize personalized human growth and learning for individuals and collectives.
2
DISTRIBUTED, STIGMERGIC FOUNDATIONS OF COLLECTIVE SENSE-MAKING
Sense-making refers to processes by which agents make sense of their environment, achieved by organizing sense
data until the environment is understood well enough to enable reasonable decisions [21]. Theories of extended [5]
and stigmergic [15] cognition highlight the integral role of environment modification in sense making; agents actively
...
of large-scale groups [6]. In stigmergic communication, the environment acts as a kind of distributed memory; modifi-
...
Storage
Users
Open Source Attention: Maker-centric eco-system
Current: platform-centric eco-system
...
HT ’22, June 28-July 1, 2022, Barcelona, Spain
interactions of agents, and immergence (individual interactions informed by a global state of affairs) [15]. Sense-making
...
for humans [12, 15] and machines [13], due to the sheer volume of information as well as challenges in endogenous
...
3
OPEN-SOURCING STIGMERGIC MARKERS FOR HEALTHIER EPISTEMIC ENVIRONMENTS
...
Healthier epistemic environments involve moving from exploitation of attention to supporting our intentions [23]. This
transition requires two paradigm shifts. First, a mindset shift on the human side, from passive, unwitting users consuming
“unhealthy information diets” [9], to active makers, who cultivate growth-oriented intentions and are mindful of the
...
navigating vast digital landscapes, but to a large degree are controlled by platforms [13]. Accordingly, the second
...
to drive algorithmic optimization towards platform growth [20]. Human-centric content discovery requires supplanting
...
individual or collective growth. Content moderation is an important representative example [16]: moderation is
...
3.2
Open Source Attention: maker-centered information ecology
Analogously to open-source code and common domain knowledge [10], stigmergic markers can be thought of as a public
...
not just where platforms provide like buttons [3]. Some types of markers should themselves be mark-able, allowing for
example the option to “like” a particular annotation, or link between two annotations. Future extensions can address
implicit stigmergic markers such as read-time or click-through counts [14].Apps recording these function as automatic
...
services. Identity provision is a key related service that can (but does not have to be) provided along with storage [20].
...
that better moderate trolls, promote thought-provoking stories, or provide customizable feed controls [16].
4
DISCUSSION
...
media, financial ledgers and executable contracts [4]. Closest to our proposal is the Solid eco-system [18] that, similarly,
targets “re-decentralizing the web” [20], and empowers individuals to control their data. Solid also features a marketplace
of services, including the dokieli decentralized annotation client for scientific research [3]. While Solid and dokieli are
inspiring initial steps, they are limited with regard to content discovery services or social incentives. More broadly,
...
economic incentives, social incentives lead experts to freely share high-quality information publicly [17].
...
not platforms” approach [16]; rather than head-to-head competition between PKMs, existing PKM growth can be
...
to the right sort of things” [23]. We have claimed that attending “to the right things” will require re-imagining our
...
this vital cause.
ACKNOWLEDGMENTS
We thank Nimrod Talmon and the DAOStack team for thoughtful feedback and support, and we thank Metagov and
RadicalXChange for cultivating the wonderful real-world and online spaces that seeded this collaboration.
REFERENCES
...
[3] Sarven Capadisli. 2020. Linked research on the decentralised Web. (2020).
[4] Fran Casino, Thomas K Dasaklis, and Constantinos Patsakis. 2019. A systematic literature review of blockchain-based applications: Current status,
classification and open issues. Telematics and Informatics 36 (2019), 55–81. https://doi.org/10.1016/j.tele.2018.11.006
[5] Andy Clark and David Chalmers. 1998. The extended mind. analysis 58, 1 (1998), 7–19.
[6] Mark Elliott. 2006. Stigmergic Collaboration: The Evolution of Group Work: Introduction. M/C Journal 9, 2 (may 2006). https://doi.org/10.5204/mcj.
2599
[7] Nigel R. Franks and J. L. Deneubourg. 1997. Self-organizing nest construction in ants: individual worker behaviour and the nest’s dynamics. Animal
Behaviour 54 (1997), 779–796.
[8] Todd M. Gureckis and Robert L. Goldstone. 2006. Thinking in groups. Pragmatics & Cognition 14 (2006), 293–311.
[9] C Johnson. 2011. The Information Diet: A Case for Conscious Consumption. O’Reilly Media. https://books.google.com/books?id=QrW62y9l3lYC
[10] Vasilis Kostakis, Vasilis Niaros, George Dafermos, and Michel Bauwens. 2015. Design global, manufacture local: Exploring the contours of an
emerging productive model. Futures 73 (2015), 126–135. https://doi.org/10.1016/j.futures.2015.09.001
[11] Anastasia Kozyreva, Stephan Lewandowsky, and Ralph Hertwig. 2020. Citizens Versus the Internet: Confronting Digital Challenges With Cognitive
Tools. Psychological Science in the Public Interest 21, 3 (2020), 103–156. https://doi.org/10.1177/1529100620946707
[12] N Levy. 2021. Bad Beliefs: Why They Happen to Good People. OUP Oxford. https://books.google.com/books?id=C%5C_ZQEAAAQBAJ
[13] Philipp Lorenz-Spreen, Stephan Lewandowsky, Cass R Sunstein, and Ralph Hertwig. 2020. How behavioural sciences can promote truth, autonomy
and democratic discourse online. Nature human behaviour 4, 11 (2020), 1102–1109.
[14] Artur Sancho Marques and José Figueiredo. 2013. Stigmergic hyperlink: A new social web object. Information Systems and Modern Society: Social
Change and Global Development (2013), 260–272. https://doi.org/10.4018/978-1-4666-2922-6.ch016
[15] Leslie Marsh and Christian Onof. 2008. Stigmergic epistemology, stigmergic cognition. Cognitive Systems Research 9, 1-2 (2008), 136–149.
https://doi.org/10.1016/j.cogsys.2007.06.009
[16] Mike Masnick. 2019. Protocols, Not Platforms. Knight First Amendment Institute (2019).
[17] Daniel S. Quintana. 2020. Twitter for Scientists [eBook edition]. https://doi.org/10.5281/ZENODO.3707741
[18] Andrei Sambra, Amy Guy, Sarven Capadisli, and Nicola Greco. 2016. Building Decentralized Applications for the Social Web. In Proceedings of the
...
[19] Chirag Shah and Emily M. Bender. 2022. Situating Search. In ACM SIGIR Conference on Human Information Interaction and Retrieval (Regensburg,
Germany) (CHIIR ’22). Association for Computing Machinery, New York, NY, USA, 221–232. https://doi.org/10.1145/3498366.3505816
[20] Ruben Verborgh. 2022. Re-decentralizing the Web, for good this time. In Linking the World’s Information: A Collection of Essays on the Work of Sir
Tim Berners-Lee, Oshani Seneviratne and James Hendler (Eds.). ACM. https://ruben.verborgh.org/articles/redecentralizing-the-web/
[21] K E Weick and K E W Weick. 1995. Sensemaking in Organizations. SAGE Publications. https://books.google.com/books?id=nz1RT-xskeoC
[22] Jevin D West and Carl T. Bergstrom. 2021. Misinformation in and about science. Proceedings of the National Academy of Sciences 118, 15 (apr 2021),
e1912444117. https://doi.org/10.1073/pnas.1912444117
[23] James Williams. 2018. Stand out of our light: freedom and resistance in the attention economy. Cambridge University Press.
[24] S Zuboff. 2019. The Age of Surveillance Capitalism: The Fight for a Human Future at the New Frontier of Power. PublicAffairs. https://books.google.
com/books?id=lRqrDQAAQBAJ
[25] Ethan Zuckerman. 2020. The Case for Digital Public Infrastructure. The Tech Giants, Monopoly Power, and Public Discourse: An Essay Series by the
