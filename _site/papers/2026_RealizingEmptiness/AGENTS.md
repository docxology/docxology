# AGENTS.md — Realizing Emptiness: Operational Surrogates for No-Self-Evidence, QRF Opacification, and Bayesian Model Reduction

**Paper**: Realizing Emptiness: Operational Surrogates for No-Self-Evidence, QRF Opacification, and Bayesian Model Reduction (2026)
...
- Tracks citation links and DOI consistency for RealizingEmptiness
...
### 🔗 INTEGRATOR
- Connects Realizing Emptiness: Operational Surrogates for No-Self-Evidence, QRF Opacification, and Bayesian Model Reduction to related works in the bibliography
...
### Related Software
- https://github.com/docxology/realizing_emptiness
