# AGENTS.md — Mapping William Blake's Works: Evidence ledgers, source provenance, text-image diagnostics, and rights-bounded release controls

**Paper**: Mapping William Blake's Works: Evidence ledgers, source provenance, text-image diagnostics, and rights-bounded release controls (2026)
...
- Tracks citation links and DOI consistency for MappingWilliamBlake
...
### 🔗 INTEGRATOR
- Connects Mapping William Blake's Works: Evidence ledgers, source provenance, text-image diagnostics, and rights-bounded release controls to related works in the bibliography
...
### Related Software
- https://github.com/docxology/blake
