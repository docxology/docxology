# AGENTS.md — Slides for Iris

**Paper**: Slides for Iris (2023)
...
- Tracks citation links and DOI consistency for SlidesIris
...
### 🔗 INTEGRATOR
- Connects Slides for Iris to related works in the bibliography
