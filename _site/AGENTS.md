...
| 2026-07-17 | MAINTAINER / WEB DEVELOPER | Fixed UTC/local report-boundary selection and generated timestamp churn; made the ordered `regenerate_all.py` chain byte-stable on a second pass; added compact/lazy artwork indexing (`data/artworks-index.json` + `build_artwork_index.py`); added 7-scenario progressive browser QA; corrected the stale animation runbook; refreshed public-source/repository/pairing reports; validation, 186 tests, 10/10 smoke, 26 visual screenshots, 7/7 browser QA, Pages artifact, GSC preflight, and 17/17 live snapshot gates pass | ✅ |
| 2026-07-17 | MAINTAINER / WEB DEVELOPER | Added generated `VideoIndex.v1` for compact timeline loading while preserving the complete video export; extended the uncatalogued-repository review queue with description-quality and metadata triage; added repository/CV/evidence/accessibility/live runbooks; reordered the regeneration tail to re-audit the generated catalog; validation and 189 tests pass | ✅ |
