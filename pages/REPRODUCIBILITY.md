...
What a third party can check about each of 215 catalogued works without asking the author for anything.
...
| --- | --- | --- | --- |
| Persistent identifier | 200 / 215 | 93% | Resolve a DOI instead of trusting a live URL. |
