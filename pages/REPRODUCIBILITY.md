...
| Open full text | 173 / 206 | 84% | Read the full text without a paywall or request. |
| Source documents | 189 / 206 | 92% | Inspect the working folder behind the entry. |
| Executable code | 28 / 206 | 14% | Run the software that produced or accompanies it. |
| Agent-readable guidance | 189 / 206 | 92% | Parse structured guidance without scraping prose. |

Mean score 4.461 of 6.

## Bands

| Band | Works | Share | Meaning |
| --- | --- | --- | --- |
| independently reproducible | 134 | 65% | Code, archive, and text are all reachable without contacting the author. |
