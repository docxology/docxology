...
What a third party can check about each of 212 catalogued works without asking the author for anything.
...
| --- | --- | --- | --- |
| Persistent identifier | 197 / 212 | 93% | Resolve a DOI instead of trusting a live URL. |
...
| Executable code | 65 / 212 | 31% | Run the software that produced or accompanies it. |
| Agent-readable guidance | 195 / 212 | 92% | Parse structured guidance without scraping prose. |

Mean score 4.703 of 6.

## Bands

| Band | Works | Share | Meaning |
| --- | --- | --- | --- |
| independently reproducible | 150 | 71% | Code, archive, and text are all reachable without contacting the author. |
