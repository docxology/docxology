...
What a third party can check about each of 211 catalogued works without asking the author for anything.
...
| --- | --- | --- | --- |
| Persistent identifier | 196 / 211 | 93% | Resolve a DOI instead of trusting a live URL. |
| Public archive | 154 / 211 | 73% | Fetch a deposited copy from a third-party archive. |
| Open full text | 189 / 211 | 90% | Read the full text without a paywall or request. |
| Source documents | 194 / 211 | 92% | Inspect the working folder behind the entry. |
| Executable code | 63 / 211 | 30% | Run the software that produced or accompanies it. |
| Agent-readable guidance | 194 / 211 | 92% | Parse structured guidance without scraping prose. |

Mean score 4.692 of 6.
