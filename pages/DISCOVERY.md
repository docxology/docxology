...
| Coverage exceptions | [data/coverage-exceptions.json](../data/coverage-exceptions.json) · [source coverage report](../reports/source_coverage_2026-09-14.md) | Explicit paper-folder, full-text, DOI, canonical-URL, and non-paper coverage gaps; review queue rather than automatic rejection |
...
| External-link report | [reports/external_links_2026-09-11.json](../reports/external_links_2026-09-11.json) | Cached scoped network check for site-critical outbound links |
| External-link triage | [reports/external_links_triage_2026-09-11.md](../reports/external_links_triage_2026-09-11.md) | Categorized link warnings: bot-protected, transient, timeout, stale, and review |
| Live-site verification | [latest dated report](../reports/live_site_verification_2026-09-12.json) | Deployed-site checks for expected markers, JSON contracts/counts, cache headers, deployment metadata, and GitHub Pages status |
| Asset-size audit | [reports/asset_size_2026-09-14.json](../reports/asset_size_2026-09-14.json) | Size budget report for public assets and generated exports |
| Static accessibility report | [reports/accessibility_static_2026-09-14.json](../reports/accessibility_static_2026-09-14.json) | Static accessibility checks for root HTML pages |
