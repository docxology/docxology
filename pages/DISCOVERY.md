...
| Index | Link | Notes |
|-------|------|-------|
| PubMed | [Daniel Ari Friedman author search](https://pubmed.ncbi.nlm.nih.gov/?term=Daniel+Ari+Friedman%5BAuthor%5D) | NCBI E-utilities returned 8 records for the exact author query on 2026-07-17 |
...
| Public-source snapshot | [reports/public_source_snapshot_2026-07-17.json](../reports/public_source_snapshot_2026-07-17.json) | Latest public API freshness report |
| Public-source inventory | [reports/public_source_inventory_2026-07-17.json](../reports/public_source_inventory_2026-07-17.json) | Paginated public-source inventory for ORCID, Crossref, PubMed, Europe PMC, Zenodo, Wikidata, Semantic Scholar, GitHub, and AII pages |
