...
| Coverage exceptions | [data/coverage-exceptions.json](../data/coverage-exceptions.json) · [source coverage report](../reports/source_coverage_2026-09-10.md) | Explicit paper-folder, full-text, DOI, canonical-URL, and non-paper coverage gaps; review queue rather than automatic rejection |
...
| Asset-size audit | [reports/asset_size_2026-09-10.json](../reports/asset_size_2026-09-10.json) | Size budget report for public assets and generated exports |
| Static accessibility report | [reports/accessibility_static_2026-09-10.json](../reports/accessibility_static_2026-09-10.json) | Static accessibility checks for root HTML pages |
