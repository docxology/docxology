...
*Last updated: 2026-05-28 from public APIs and official profile pages*
...
| GitHub | [@docxology](https://github.com/docxology) | Primary software profile; GitHub API returned 299 public repositories on 2026-05-28 |
...
| Index | Link | Notes |
|-------|------|-------|
| PubMed | [Daniel Ari Friedman author search](https://pubmed.ncbi.nlm.nih.gov/?term=Daniel+Ari+Friedman%5BAuthor%5D) | NCBI E-utilities returned 8 records for the exact author query on 2026-05-28 |
| Europe PMC | [Daniel Ari Friedman author search](https://europepmc.org/search?query=AUTH:%22Daniel%20Ari%20Friedman%22) | Europe PMC returned 10 exact-author results, including preprints, on 2026-05-28 |
| Crossref API | [ORCID DOI records](https://api.crossref.org/works?filter=orcid:0000-0001-6232-9096) | Crossref returned 15 DOI records attached to the ORCID on 2026-05-28 |
| Zenodo | [Exact-name creator search](https://zenodo.org/search?q=metadata.creators.person_or_org.name%3A%22Friedman%2C%20Daniel%20Ari%22) | Zenodo returned 38 exact-name records on 2026-05-28 |
| Zenodo API | [ORCID-linked records](https://zenodo.org/api/records?q=metadata.creators.person_or_org.identifiers.identifier%3A%220000-0001-6232-9096%22) | ORCID-linked query returned 91 records, including versioned deposits and software archives |
...
| GitHub API — AII | [api.github.com/users/ActiveInferenceInstitute](https://api.github.com/users/ActiveInferenceInstitute) | Returned 51 public repositories on 2026-05-28; local catalog tracks 32 AII repositories with docxology contributions. **Note:** the `ActiveInferenceInstitute` account is a GitHub **User**, not an Organization — use `/users/`; `/orgs/ActiveInferenceInstitute` returns 404. |
...
| Public-source snapshot | [reports/public_source_snapshot_2026-05-28.json](../reports/public_source_snapshot_2026-05-28.json) | Latest public API freshness report |
| Public-source inventory | [reports/public_source_inventory_2026-05-28.json](../reports/public_source_inventory_2026-05-28.json) | Paginated public-source inventory for ORCID, Crossref, PubMed, Europe PMC, Zenodo, Wikidata, Semantic Scholar, GitHub, and AII pages |
| Reconciliation report | [reports/reconciliation_2026-05-28.md](../reports/reconciliation_2026-05-28.md) | Human-readable comparison of curated counts and public-source counts |
